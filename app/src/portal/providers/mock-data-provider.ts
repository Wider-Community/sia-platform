...
function seed() {
  ...
  const seedOrgs: MockRecord[] = [
    { id: "org-1", name: "Abu Dhabi Investment Authority", type: "investor", status: "active", stage: "negotiation", locations: [{ id: "loc-1", country: "AE", countryName: "United Arab Emirates", city: "Abu Dhabi", lat: 24.4539, lng: 54.3773, isDefault: true }], website: "https://adia.ae", description: "Sovereign wealth fund", tags: ["sovereign", "institutional"], createdAt: "2026-01-15T10:00:00Z", updatedAt: "2026-04-01T10:00:00Z" },
    { id: "org-2", name: "Saudi Aramco Ventures", type: "partner", status: "active", stage: "active_partner", locations: [{ id: "loc-2", country: "SA", countryName: "Saudi Arabia", city: "Dhahran", lat: 26.2361, lng: 50.0393, isDefault: true }], website: "https://aramco.com", description: "Corporate venture arm", tags: ["energy", "corporate"], createdAt: "2026-02-01T10:00:00Z", updatedAt: "2026-03-15T10:00:00Z" },
    { id: "org-3", name: "Dubai Future Foundation", type: "partner", status: "prospect", stage: "engaged", locations: [{ id: "loc-3", country: "AE", countryName: "United Arab Emirates", city: "Dubai", lat: 25.2048, lng: 55.2708, isDefault: true }], website: "https://dubaifuture.gov.ae", description: "Government innovation entity", tags: ["government", "innovation"], createdAt: "2026-03-01T10:00:00Z", updatedAt: "2026-04-10T10:00:00Z" },
    { id: "org-4", name: "Mubadala Investment Company", type: "investor", status: "active", stage: "due_diligence", locations: [{ id: "loc-4", country: "AE", countryName: "United Arab Emirates", city: "Abu Dhabi", lat: 24.4539, lng: 54.3773, isDefault: true }], website: "https://mubadala.com", description: "Sovereign investor", tags: ["sovereign", "diversified"], createdAt: "2026-01-20T10:00:00Z", updatedAt: "2026-04-20T10:00:00Z" },
    { id: "org-5", name: "NEOM Tech & Digital", type: "vendor", status: "inactive", stage: "inactive", locations: [{ id: "loc-5a", country: "SA", countryName: "Saudi Arabia", city: "NEOM", lat: 28.0000, lng: 35.0000, isDefault: true }, { id: "loc-5b", country: "SA", countryName: "Saudi Arabia", city: "Riyadh", lat: 24.7136, lng: 46.6753, isDefault: false }], website: "https://neom.com", description: "Smart city tech division", tags: ["technology", "smart-city"], createdAt: "2026-02-15T10:00:00Z", updatedAt: "2026-03-01T10:00:00Z" },
  ];
  orgs.push(...seedOrgs);
