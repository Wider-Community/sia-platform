...
/**
 * Separated component so useGoogleLogin hook only runs inside GoogleOAuthProvider.
 * This component is conditionally rendered only when hasGoogleOAuth is true,
 * which means GoogleOAuthProvider is wrapping the app in main.tsx.
 */
function GoogleLoginButton({ onError }: { onError: (msg: string | null) => void }) {
