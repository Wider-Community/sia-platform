...
export function IlluminatedHero() {
  return (
    <div className="relative w-full flex h-screen flex-wrap items-center justify-center overflow-hidden bg-black text-white">
      <div className="bg absolute h-full w-full max-w-[44em]">
        <div className="shadow-bgt absolute size-full scale-[1.2] animate-[onloadbgt_1s_ease-in-out_forwards] rounded-[100em] opacity-60" />
        <div className="shadow-bgb absolute size-full scale-[1.2] animate-[onloadbgb_1s_ease-in-out_forwards] rounded-[100em] opacity-60" />
      </div>
      ...
      <p className="absolute top-0 bottom-0 m-auto h-fit max-w-[28em] translate-y-[12em] bg-gradient-to-t from-[#86868b] to-[#bdc2c9] bg-clip-text text-center font-semibold text-transparent">
        Ondo designs institutional-grade platforms, assets, and infrastructure to bring financial markets onchain.{' '}
        <span className="relative inline-block font-black text-[#e7dfd6]">
          Tokenized real-world assets
        </span>{' '}
        — built for the world&apos;s leading institutions.
      </p>
